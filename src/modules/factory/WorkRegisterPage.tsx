...
const carModels: Record<string, string[]> = {
  ...
  기아: ["K3", "K5", "K8", "쏘렌토", "스포티지", "카니발", "모닝","니로","EV6","셀토스","쏘울","스토닉","레이","봉고3"],
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-slate-100">
                <th className="w-28 border border-slate-300 px-3 py-2 text-center text-sm font-semibold text-slate-800">
                  좌우
                </th>
                <th className="border border-slate-300 px-3 py-2 text-left text-sm font-semibold text-slate-800">
                  부위
                </th>
                <th className="border border-slate-300 px-3 py-2 text-left text-sm font-semibold text-slate-800">
                  작업내용
                </th>
                <th className="w-24 border border-slate-300 px-3 py-2 text-center text-sm font-semibold text-slate-800">
                  삭제
                </th>
              </tr>
            </thead>
